...
//   deployer.deploy(FastCoin).then(function(){
//     return deployer.deploy(RewardsLoyalty, FastCoin.address);
//   });
...
//   deployer.deploy(OrderContract, MenuManagement.address, promotions.address, RewardsLoyalty.address, FastCoin.address);
// };
